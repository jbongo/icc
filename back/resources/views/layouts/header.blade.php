...
<div class="header">
        ...
        <div class="pull-right p-r-15">
            <ul>
                ...
                <li class="header-icon dib"><i class="large material-icons">notifications</i> <span class="badge badge-pill badge-danger" style="border-radius: 112px 112px 112px 112px;"></span>
                    <div class="drop-down">
                        ...
                        <div class="dropdown-content-body">
                            <ul>
                                ...
                                <a href="" class="more-link">Afficher tous</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <li class="header-icon dib"><img class="avatar-img" src="{{ asset('images/avatar/1.jpg') }}" alt="" /> <span class="user-avatar">  <i class="ti-angle-down f-s-10"></i></span>
